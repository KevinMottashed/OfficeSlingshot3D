...
/** Initialize a specific haptic device
 **
 ...
 **   <li> lib directory in path specified by HDAL_BASE </li>
 ...
 **
 ** @note
 ** - Support multiple phantom devices via deviceName string.
 ** - Currently only supports a single Falcon device (deviceName ignored).
 **
 ** @note
 ** Setup sequence:
 ** @code
 ...
 ** hdlUninitDevice(...);
 ** @endcode
 ** @see hdlStart, hdlStop, hdlCreateServoOp, hdlDestroyServoOp, hdlUninitDevice
 **
 */
 ...
 ** @par
 ** @see hdlStop, hdlInitNamedDevice
 */
 ...
 ** @return Nothing
 ** @par
 ** @see hdlStart, hdlInitNamedDevice
 */
 ...
 ** Errors: None
 ** @par
 ** @see hdlDestroyServoOp, hdlInitNamedDevice
 */
 ...
 ** @par
 ** @see hdlCreateServoOp, hdlInitNamedDevice
 */
 ...
 ** Errors: None.
 */
HDLAPI _int64 HDLAPIENTRY HDL_BUILD_VERSION(HDL_VERSION_INFO_TYPE versionInfo);
