...
// by gaecha
//
//  Convert from  D to YUV420
//
int ConvertD2YUV(int w,int h,unsigned char *bmp,unsigned int *yuv)
{
...
//Get YUV values for rgb values...
	...
	for(i=0;i<h;i++)
	{
		...
		for(j=0;j<w;j++)
		{
		*y++=( RGB2YUV_YR[*r]  +RGB2YUV_YG[*r]+RGB2YUV_YB[*r]+1048576)>>16;
		*u++=(-RGB2YUV_UR[*r]  -RGB2YUV_UG[*r]+RGB2YUV_UBVR[*r]+8388608)>>16;
		*v++=( RGB2YUV_UBVR[*r]-RGB2YUV_VG[*r]-RGB2YUV_VB[*r]+8388608)>>16;
